...
//  */
// router.post('/iam/login/otp/verify', validatePasswordSetupComplete, async (req, res) => {
//   try {
...
//       activationToken,
//       nonce,
//       identifier: username,  // Pass username for display on Keycloak login page
//       redirectUri:"http://localhost:4000/*",   //redirectUri: FRONTEND_REDIRECT_URI,
